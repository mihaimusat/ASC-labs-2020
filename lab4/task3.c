...
int main(void)
{
    ...
    /* observam ca int32_t -> aliniat la multiplu de 4
 		   int64_t -> aliniat la multiplu de 8
    		   struct a -> aliniata la multiplu de 16 -> cam dubios
    		   struct b -> aliniata tot la multiplu de 16 -> cam dubios
    */
    ...
    // pentru struct b se face padding pentru alinierea datelor
    printf("a: %zd\n", sizeof(struct a));
    printf("b: %zd\n", sizeof(struct b));
